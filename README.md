...
| `micro_xrce_dds_agent`                    | 	Contains the protocol agent responsible for the communication bridge between the companion computer and the flight controller.              | [[Link to repo]([https://github.com/LASER-Robotics/px4_msgs](https://github.com/LASER-Robotics/micro_xrce_dds_agent))]                                  | 
